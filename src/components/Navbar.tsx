...
export default function Navbar() {
  ...
  return (
    <>
      <AdminSidebar isOpen={isSidebarOpen} setIsOpen={setIsSidebarOpen} role={role} />
          ...
          <div className="flex items-center gap-3">
            {(role === "admin" || role === "keuangan") && (
              <button
                ...
                className="p-2 -ml-2 rounded-xl text-slate-500 hover:text-cyan-600 hover:bg-cyan-50 dark:hover:bg-cyan-500/20 transition-colors"
